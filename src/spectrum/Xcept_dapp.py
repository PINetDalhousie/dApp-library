...
class XceptDApp(DApp):
    ...
    def __init__(self, id: int = 1, model_deployment: str = 'gpu', model_type: str = 'tf', noise_floor_threshold: int = 53, save_iqs: bool = False, control: bool = False, link: str = 'posix', transport:str = 'udc', **kwargs):
        ...
        if self.model_type == 'trt':
            self.model_path = '/users/grad/boeira/dApp/src/model_files/xcept_model.engine'
        elif self.model_type == 'tensorlite':
            self.model_path = '/users/grad/boeira/dApp/src/model_files/Xcept.tflite'
        else:
            self.model_path = '/users/grad/boeira/dApp/src/model_files/xcept_trained_model.keras'
